...
export type NavMenuItemVariant = 'default' | 'destructive';

@Component({
  selector: 'div[spark-navmenu-item]',
...
export class NavMenuItemComponent {
  ...
  readonly variant = input<NavMenuItemVariant>('default');
  ...
  protected readonly tabindex = computed(() => {
    ...
    const enabledItems = items.filter((item: NavMenuItemDef) => !item.disabled);
    const index = enabledItems.findIndex((item: NavMenuItemDef) => item.value === this.value());
